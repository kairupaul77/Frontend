...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-xl mb-8 text-center max-w-3xl text-white">
      ...
      <h2 className="text-4xl font-bold mb-6 text-white">ORDER YOUR FAVORITE MEALS</h2>
      <h3 className="text-2xl font-semibold mb-8 text-white">FEATURED MEALS</h3>
      ...
      <div className="grid grid-cols-2 gap-12 mb-12">
        {["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjAMLedZRk2kc2Gg7NC0jRaHIjxa1-vf-b_A&s",
          ...
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzUXwxKjDkf17YKakug9okRsOuGVhZD8h6RA&s"].map((src, index) => (
          <img
            key={index}
            src={src}
      ...
      <button
        ...
        className="bg-green-500 hover:bg-green-600 font-bold text-4xl py-6 px-16 rounded-lg shadow-lg transition-transform transform hover:scale-105 text-white"
      >
        BOOK NOW
      </button>
    </div>
